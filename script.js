        ...
        resultsContainer.innerHTML = journals.map((journal) => `
            <article class="journal-card">
                ...
                <div class="journal-actions">
                    <a href="${api.getDownloadUrl(journal.id)}" class="downloadpdf" target="_blank" rel="noopener"><img class="downloadpdf-icon" width='15' src='https://img.icons8.com/?size=20&id=86297&format=png&color=1a5a96'> PDF</a>
                </div>
            </article>
        `).join('');
    };
              ...
              .map(
                ...
                <article class="journal-card">
                  ...
                  journal.title || "Untitled"
                    ...
                    <div class="journal-actions">
                        <a href="${api.getDownloadUrl(journal.id)}" class="downloadpdf" target="_blank" rel="noopener"><img class="downloadpdf-icon" src='https://img.icons8.com/?size=20&id=86297&format=png&color=1a5a96'> PDF</a>
                    </div>
                </article>
            `
              )
